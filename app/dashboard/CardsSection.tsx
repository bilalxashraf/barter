      ...
      {cardsEnabled && !profile ? (
        <form onSubmit={handleCreateProfile} style={{ display: 'grid', gap: 16, marginTop: 16 }}>
          ...
          <label style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            />
            <span>I accept the Ignotus Cards terms for creating and funding virtual cards.</span>
          </label>
        ...
        <div style={{ display: 'grid', gap: 18, marginTop: 16 }}>
          ...
          <section style={panelStyle}>
            <div style={{ marginBottom: 12 }}>
              ...
              <p className="muted">Fund your Ignotus Cards balance through hosted Stripe checkout.</p>
            </div>
