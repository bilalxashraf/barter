      ...
      <div className="relative z-10">
        ...
        <section className="px-6 pt-16 pb-20 max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="/home" className="w-full sm:w-auto rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-base font-medium text-white/70 hover:border-white/20 hover:text-white transition-all text-center">
              Explore →
            </a>
          </div>
